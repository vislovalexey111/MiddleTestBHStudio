...
public class NetworkRoomPlayerExtended : NetworkRoomPlayer
{
    ...
    [SyncVar(hook = nameof(NameChanged))] public string Name;
    ...
    public override void OnClientEnterRoom()
    {
        ...
        if (isLocalPlayer)
            CmdChangeName(PlayerNameInput.DisplayName);
    }
    ...
    public void NameChanged(string _, string newName) => _networkManager.OnUpdateUI?.Invoke();
